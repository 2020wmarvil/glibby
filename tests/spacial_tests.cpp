...
TEST_CASE("QuadTree iterator testing with insertion and removal","[spacial][QuadTree]")
{
  std::shared_ptr<glibby::Point2D> pt1(new glibby::Point2D);
  pt1->x = 0.00f;
  pt1->y = 0.00f;
...
TEST_CASE("OcTree iterator testing","[spacial][OcTree]")
{
  ...
  float points_x[25] = {0, -2, -2,  2,  2, -2, -2,  2,  2, -3, -3, -1, -1, -3, -3, -1, -1,  1,  1,  3,  3,  1,  1,  3,  3};
  float points_y[25] = {0, -2,  2,  2, -2, -2,  2, -2,  2, -3, -1, -1, -3,  1,  3,  3,  1,  1,  3,  3,  1, -3, -1, -1, -3};
  float points_z[25] = {0, -2, -2, -2, -2,  2,  2,  2,  2, -3, -3, -1, -1,  3,  3,  1,  1,  3,  3,  1,  1, -3, -3, -1, -1};
